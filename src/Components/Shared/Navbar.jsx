...
const Navbar = () => {
    ...
    {/* Navbar link for the big screen */}
    ...
    <div>
     ...
     <button className="text-2xl scale-100 hover:scale-125 duration-200 transition-all lg:hidden" onClick={toggleDrawer}><AiOutlineMenuFold /></button>
    ...
    <Drawer
            ...
            >
                <div className="bg-[#06112a] h-full w-full flex flex-col ">
                <ul className="flex flex-col text-white">
                 <li className="border-b pl-3 py-4 block cursor-pointer hover:bg-[#01081a] hover:text-[18px] transition-all duration-200">Home</li> 
                 <li className="border-b pl-3 py-4 block cursor-pointer hover:bg-[#01081a] hover:text-[18px] transition-all duration-200">Service</li>     
                 <li className="border-b pl-3 py-4 block cursor-pointer hover:bg-[#01081a] hover:text-[18px] transition-all duration-200">Team</li>     
                 <li className="border-b pl-3 py-4 block cursor-pointer hover:bg-[#01081a] hover:text-[18px] transition-all duration-200">Blog</li> 
                 <li className="border-b pl-3 py-4 block cursor-pointer hover:bg-[#01081a] hover:text-[18px] transition-all duration-200">Contact</li>         
